...
gratitude: gratitude-1 gratitude-2 gratitude-3 gratitude-4
gratitude-1: setup output/poster-gratitude-1.pdf
gratitude-2: setup output/poster-gratitude-2.pdf
gratitude-3: setup output/poster-gratitude-3.pdf
gratitude-4: setup output/poster-gratitude-4.pdf
...
# Gratitude poster 1 (Part 3a: Good Works and The Law, Q86-95)
...
# Gratitude poster 2 (Part 3b: The Law Continued, Q96-107)
...
# Gratitude poster 3 (Part 3c: The Law and Prayer, Q108-119)
output/poster-gratitude-3.pdf: posters/poster-gratitude-3.tex content/gratitude-3.tex styles/*.sty
	$(LATEX) $(LATEXFLAGS) posters/poster-gratitude-3.tex
	$(LATEX) $(LATEXFLAGS) posters/poster-gratitude-3.tex

# Gratitude poster 4 (Part 3d: The Lord's Prayer, Q120-129)
...
help:
	...
	@echo ""
	@echo "Targets:"
	@echo "  all          - Build all twelve posters"
	...
	@echo "  gratitude    - Build all four Gratitude posters"
	@echo "  gratitude-1  - Build Gratitude poster 1 (Q86-95, Good Works/Law)"
	@echo "  gratitude-2  - Build Gratitude poster 2 (Q96-107, Law Continued)"
	@echo "  gratitude-3  - Build Gratitude poster 3 (Q108-119, Law/Prayer)"
	@echo "  gratitude-4  - Build Gratitude poster 4 (Q120-129, Lord's Prayer)"
